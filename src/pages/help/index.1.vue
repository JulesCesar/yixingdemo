<template> 
  <div> 
            <!-- <v-radio v-model="radio" label="Permission" > 1、管理员登录</v-radio>
            <br/> 
            <v-radio v-model="radio" label="Recordloader">2、出纳记一笔流水账</v-radio>
            <br/> 
            3、出纳上传银行数据
            <v-radio v-model="radio" label="MoneyAccount"> 3.1 创建银行帐户</v-radio>
            <v-radio v-model="radio" label="RecordImportData"> 3.2 上传银行数据</v-radio>
        <br/>   
        ...
        <v-row>
              ...
              <div class="app-wrapper"  id="lasthover">
                <div class="image-grid-left">
                  <div class="image" v-for="pic in picdata" style="text-align: center;">
                    ...
                    <!-- <div class="image-grid-left-jt">
                      <img src="../../assets/img/jt4.svg" width='56' alt="">
                    </div> -->
                  </div>
                </div>
            ...
            <v-col span="6" style="margin-right:70px;margin-left:70px;">
              <!-- 中间picdatacenter -->
            ...
            <v-col span="8">
              ...
              <div class="app-wrapper">
                ...
                <!-- <img src="../../assets/img/jtleft1.svg" alt=""> -->
              </div>
            </v-col>
        </v-row>
...
<span style="color:#4f94e2;">温馨提示：{{radiotext}}或点击下载</span> 
          <!-- 弹出 -->
                <div style="display: inline-block;color: #3296fa;font-size: 14px;">
                  <a :href="process.env.NODE_ENV==='development'?'../../static/img/manualV2.6.pdf':'../../app/static/img/manualV2.6.pdf'" download="首席财务官产品使用说明文档V2.6.pdf">《产品手册》</a>
                  <!-- <a href="/user/test/xxxx.txt" download="文件名.txt">点击下载</a> -->
                   <v-icon type="file-pdf" style="font-size:14px;"></v-icon>
                </div>
      ...
      picdata: [
        {
          ...
          imgUrl: process.env.NODE_ENV==='development'?'../../static/img/holp1-1.png':'../../app/static/img/holp1-1.png'
        },
        {
          id: 2,
          caption: '出纳记一笔流水账',
          ...
          imgUrl: process.env.NODE_ENV==='development'?'../../static/img/holp2-2.png':'../../app/static/img/holp2-2.png'
        },
      ],
      picdatacenter:[
        {
          ...
          imgUrl: process.env.NODE_ENV==='development'?'../../static/img/holp5.png':'../../app/static/img/holp5.png'
        },
      ],
      picdataright:[
        {
          ...
          imageText:'创建银行账户',
          imgUrl: process.env.NODE_ENV==='development'?'../../static/img/holp3-3.png':'../../app/static/img/holp3-3.png'
        },
        {
          id: 2,
          caption: '第二步',
          ...
          imageText:'上传银行流水',
          imgUrl: process.env.NODE_ENV==='development'?'../../static/img/holp4-4.png':'../../app/static/img/holp4-4.png'
        },
      ],
      currentPic: '',
