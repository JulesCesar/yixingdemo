...
#UploadFile1 .ant-upload-list-item {
    padding-top: 0;
        height: 66px;
    border: none;
}
#UploadFile1 .ant-upload-list-item-name{
    line-height: 68px;
}
/* #UploadFile .ant-btn{
    margin-top: 30px;
} */
#UploadFile1 .ant-upload-list-picture{
/* position: absolute;
    top: 15px; */
}
#UploadFile1 .upload-demo-start{
    margin-top: 6px;
}
#importData{
    position: relative;
