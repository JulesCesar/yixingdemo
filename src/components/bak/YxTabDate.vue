<template>
  <div style="display: flex; justify-content: flex-end; width:100%;">
    <v-radio-group type="button" size="large"  :data="[{value: 'day', text: '日'},{value: 'week', text: '周'},{value: 'month', text: '月'}]" v-model="selectValue" @change="changedRadio" />
...
export default {
  ...
  methods: {
    ...
    callback() {
      let _self = this;
      // debugger
      // console.log("test ",this.selectDate);
